...
function show(button_element) {
    ...
    */
    ...
    if(previousBtn != null){
        ...
        previousBtn.style.backgroundColor = "darkblue";
    }


    let clicked = button_element.id;
    button_element.style.backgroundColor = "aqua";
    button_element.style.color = "black";
    document.getElementById("ta-fun-fact").innerText = facts[clicked];
    document.getElementById("ta-photo").src = "./photos/" + clicked + ".jpg";
    
    previousBtn = button_element;
